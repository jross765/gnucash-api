...
public class TestGnuCashWritableTransactionImpl {
	...
	public void test03_1() throws Exception {
		...
		splt1.setQuantity(BigFraction.of(100).negate());
		splt1.setValue(BigFraction.of(100).negate());
		...
		splt2.setQuantity(BigFraction.of(100));
		splt2.setValue(BigFraction.of(100));
	...
	private void test03_1_check_memory(GnuCashWritableTransaction trx) throws Exception {
		...
		assertEquals(100.0, splt2.getQuantity().doubleValue(), ConstTest.DIFF_TOLERANCE);
		assertEquals(100,   splt2.getQuantityRat().getNumerator().intValue());
		assertEquals(1,     splt2.getQuantityRat().getDenominator().intValue());
		
		assertEquals(100.0, splt2.getValue().doubleValue(), ConstTest.DIFF_TOLERANCE);
