...
import org.gnucash.api.read.impl.hlp.fil.FileInvoiceEntryManager;
import org.gnucash.api.read.impl.hlp.fil.FileInvoiceManager;
import org.gnucash.api.read.impl.hlp.fil.FileJobManager;
import org.gnucash.api.read.impl.hlp.fil.FilePriceManager;
import org.gnucash.api.read.impl.hlp.fil.FileTaxTableManager;
import org.gnucash.api.read.impl.hlp.fil.FileTransactionManager;
import org.gnucash.api.read.impl.hlp.fil.FileVendorManager;
import org.gnucash.api.read.impl.hlp.fil.GnuCashPubIDManager;
import org.gnucash.api.read.impl.hlp.fil.NamespaceRemoverReader;
...
public class GnuCashFileImpl implements GnuCashFile, GnuCashPubIDManager {
	...
	public GnuCashFileImpl(final File pFile, final boolean withProgBar) throws IOException {
		super();
	...
	public GnuCashFileImpl(final InputStream is, final boolean withProgBar) throws IOException {
		super();
...
//	}
		...
		GnuCashTransaction trx = getTransactionByID(trxID);
		if ( trx == null ) {
		...
		for ( GnuCashTransactionSplit splt : trx.getSplits() ) {
			if ( splt.getAccountID().equals(acctID) )
			return splt;
		}
	...
	@Override
	public GnuCashCommodity getCommodityByNamSpcCode(final GCshCmdtyNameSpace.Exchange exchange, String tkr) {
		return cmdtyMgr.getCommodityByNamSpcCode(exchange, tkr);
	}

	@Override
	@Deprecated
	public GnuCashCommodity getCommodityByQualifID(final GCshCmdtyNameSpace.Exchange exchange, String tkr) {
		return cmdtyMgr.getCommodityByNamSpcCode(exchange, tkr);
	}

	@Override
	public GnuCashCommodity getCommodityByNamSpcCode(final GCshCmdtyNameSpace.MIC mic, String micID) {
		return cmdtyMgr.getCommodityByNamSpcCode(mic, micID);
	}

	@Override
	@Deprecated
	public GnuCashCommodity getCommodityByQualifID(final GCshCmdtyNameSpace.MIC mic, String micID) {
		return cmdtyMgr.getCommodityByNamSpcCode(mic, micID);
	}

	@Override
	public GnuCashCommodity getCommodityByNamSpcCode(final GCshCmdtyNameSpace.SecIdType secIdType, String secID) {
		return cmdtyMgr.getCommodityByNamSpcCode(secIdType, secID);
	}

	@Override
	@Deprecated
	public GnuCashCommodity getCommodityByQualifID(final GCshCmdtyNameSpace.SecIdType secIdType, String secID) {
		return cmdtyMgr.getCommodityByNamSpcCode(secIdType, secID);
	}
