...
import org.gnucash.api.read.impl.hlp.own.Vendor_ExpOutst_BF;
import org.gnucash.api.read.impl.hlp.own.Vendor_ExpOutst_FP;
...
//		}
	...
	public BigFraction getExpensesGeneratedRat(GnuCashGenerInvoice.ReadVariant readVar) {
		return Vendor_ExpOutst_BF.getExpensesGenerated(this, readVar);
    }
	...
	public BigFraction getExpensesGeneratedRat_direct() {
		return Vendor_ExpOutst_BF.getExpensesGenerated_direct(this);
    }
	...
	public BigFraction getExpensesGeneratedRat_viaAllJobs() {
		return Vendor_ExpOutst_BF.getExpensesGenerated_viaAllJobs(this);
    }
	...
	public String getExpensesGeneratedFormatted(GnuCashGenerInvoice.ReadVariant readVar) {
    	return getExpensesGeneratedFormatted(readVar, Locale.getDefault());
    }
	...
	public String getExpensesGeneratedFormatted(GnuCashGenerInvoice.ReadVariant readVar, final Locale lcl) {
    	return AmountFormatter_FP.formatAmount( getGnuCashFile(),
    											getExpensesGenerated(readVar), getGnuCashFile().getDefaultCurrencyID(), lcl );
    }
	...
	public BigFraction getOutstandingValueRat(GnuCashGenerInvoice.ReadVariant readVar) {
		return Vendor_ExpOutst_BF.getOutstandingValue(this, readVar);
    }
	...
	public BigFraction getOutstandingValueRat_direct() {
		return Vendor_ExpOutst_BF.getOutstandingValue_direct(this);
    }
	...
	public BigFraction getOutstandingValueRat_viaAllJobs() {
		return Vendor_ExpOutst_BF.getOutstandingValue_viaAllJobs(this);
    }
	...
	public String getOutstandingValueFormatted(GnuCashGenerInvoice.ReadVariant readVar) {
    	return getOutstandingValueFormatted(readVar, Locale.getDefault());
    }
	...
	public String getOutstandingValueFormatted(GnuCashGenerInvoice.ReadVariant readVar, final Locale lcl) {
    	return AmountFormatter_FP.formatAmount( getGnuCashFile(),
    											getOutstandingValue(readVar), getGnuCashFile().getDefaultCurrencyID(), lcl );
    }
